                      ...
                      if L1[5]!=variable:
                                 if L2[5]!=variable:
                                            if L3[5]!=variable:
                                                       ...
                                                       img=Image.open("https://github.com/abhi25819/Banking-management-system/blob/main/WA-IMG-20201226-0a9821e5.jpg?raw=true")
...
Write the given code in the box  below :-''',font=("Arial black",15),bg="Royal blue",justify=LEFT)
           ...
           def confirmbtn():
                      ...
                      if (entr_1.get()==randomno):
                                 ...
                                 w.geometry('1366x768')
                                 I=Image.open("https://github.com/abhi25819/Banking-management-system/blob/main/3c8f12b0606ad428cacccc09fd98246c-1.png?raw=true")
                                 I=I.resize((1366,768))
...
imgg=Image.open("https://github.com/abhi25819/Banking-management-system/blob/main/credit-card.png?raw=true")
...
img=Image.open("https://github.com/abhi25819/Banking-management-system/blob/main/smartphone.png?raw=true")
